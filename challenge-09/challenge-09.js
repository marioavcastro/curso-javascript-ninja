...
var sub = calculator(10,5);
var mult = calculator(2,5);
var div = calculator(14,2);
...
chamada.
*/
console.log( 'O resultado da subtração é:', sub( function(x,y){return x - y;}) );
console.log( 'O resultado da multiplicação é:', mult( function(x,y){return x * y;}) );
console.log( 'O resultado da divisão é:', div( function(x,y){return x / y;}) );
console.log( 'O resultado da modulo é:', mod( function(x,y){return x % y;}) );
/*
