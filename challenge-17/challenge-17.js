...
console.log(text.replace(/Manuel Marques de Sousa/, 'Mario Castro'));
...
console.log(text.replace(/brasileiro/, 'ludoviscence'));
...
console.log('O mês de março é representado pelo numero ' + getMonthNumber('março') + '.');
console.log('O mês de setembro é representado pelo numero ' + getMonthNumber('setembro') + '.');
console.log('O mês de dezembro é representado pelo numero ' + getMonthNumber('dezembro') + '.');
/*
...
*/
console.log( '\nReplace de datas:' );
    function replaceData(regex,day,month,year) {
        return day + '/' + getMonthNumber(month) + '/' + year;

    }

console.log(text.replace(regexDate, replaceData));
