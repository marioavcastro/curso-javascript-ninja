...
console.log(str.match(/ju[nl]ho/g));
...
var strHtml = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
console.log(strHtml.match(/<\w+>/g));
...
var strTags = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
console.log(strTags.match(/<\w+><\/\w+>/g));
...
var textoTag = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';

console.log(textoTag.replace(/<(\w+)>([^<]+)(<\/\w+>)/g, '<$1> O texto dentro da tag "$1" é "$2" </$1>'));